    ...
    <script type="text/javascript" charset="utf-8" src="/admins/plugin/lang/zh-cn/zh-cn.js"></script>
                    ...
                    <div class="am-g tpl-amazeui-form">
                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            <form class="am-form am-form-horizontal" action="/postadd" method="post" enctype="multipart/form-data">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input id="user-name" name="title" type="text">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <textarea class="" name="content" rows="8" id="editor" style="height: 300px"></textarea>
                                    </div>
                                </div>
                                {{csrf_field()}}
